...
<table class="table table-striped table-bordered table-hover">
   ...
   <h1>Commodities</h1>
    <table class="table table-striped table-bordered table-hover">
        ...
        @foreach ($customer->assets as $asset)
            <tr>
                ...
                <td>{{$asset->acquired_value *  $asset->salvage_value}}</td>
                <?php $atotal= $atotal+ ($asset->acquired_value *  $asset->salvage_value)?>
            </tr>
        @endforeach
    ...
    <h4><?php echo 'Total of Initial Commodities Portfolio is  $', number_format($atotal,2);?> </h4>
    </div>
